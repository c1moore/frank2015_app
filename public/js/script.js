	...
	appWindow.directive('frankSidebarMenu', function($location, $timeout) {
		var frankSidebarMenuDefinition = {
			...
			template : 	"<a href='directory.html' target='_self' class='btn btn-sidebar sidebar-item' role='button'><i class='fa fa-home'></i> Home</a> <br />" +
						...
						"<a href='frankbook/directory.html' target='_self' class='btn btn-sidebar sidebar-item' role='button'><i class='fa fa-users'></i> Who's Here?</a> <br />" +
						"<a href='./frankbook' target='_self' class='btn btn-sidebar sidebar-item sidebar-item-2' role='button'><i class='fa fa-user'></i> frankbook</a> <br />" +
						"<a href='frankbook/speakers.html' target='_self' class='btn btn-sidebar sidebar-item sidebar-item-2' role='button'><i class='fa fa-microphone'></i> Speaker frankbook</a> <br />" +
